...
<body class="w3-light-grey">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom" style="width: 990px;">
        ...
        <div class="w3-container" style="width: 990px;">
          

          <h6 class="w3-text-teal"><i class="fa fa- fa-fw w3-margin-right"></i> - <span class="w3-tag w3-teal w3-round">Mit app inventor</span></h6>

         <iframe width="975" height="600" src="https://www.youtube.com/embed/d5BVEVJWf0M" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
